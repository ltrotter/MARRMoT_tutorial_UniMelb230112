classdef m_07bis_gr4jdd_5p_2s < MARRMoT_model
% Class for hydrologic conceptual model: GR4J with bottomless moisture
% storage
...
% http://doi.org/10.5194/gmd-2017-264
    ...
    methods
        ...
        % creator method
        function obj = m_07bis_gr4jdd_5p_2s()            
            ...
            obj.StoreNames = {"D1", "S2"};                                 % Names for the stores
            obj.StoreSigns = [-1,1];
        ...
        function obj = init(obj)
            ...
            dd = theta(5);     % deficit-dynamic parameter [-]
            
            % max of stores
            obj.store_max = [Inf, x3];
        ...
        function [dS, fluxes] = model_fun(obj, S)
            ...
            % calculate deficit intermediate variable
            Dstar = (-(x1+D1)+sqrt((x1+D1)^2+4*(dd-1)*D1*x1))/(2*(dd-1));
            Sstar = x1-Dstar;
